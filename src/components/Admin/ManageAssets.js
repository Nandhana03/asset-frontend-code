...
// import { FiEdit2, FiTrash2, FiPlus, FiX } from 'react-icons/fi';
// import '../../styles/ManageAssets.css';
// import API from '../../services/api'; // Make sure this axios instance is configured
...
//             <select value={current.categoryName} onChange={e => setCurrent({ ...current, categoryName: e.target.value })}>
